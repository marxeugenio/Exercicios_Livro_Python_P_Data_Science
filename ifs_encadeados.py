...
if igual_ou_abaixo_da_media:
    print("O valor da amosstra fornecida é igual ou menor que a media do grupo em estudo")
else:
    print("O valor da amostra fornecida é superior á media do grupo em estudo")
